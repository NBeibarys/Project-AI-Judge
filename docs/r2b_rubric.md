# R2B (Road 2 Battlefield) Grading Rubric

6 criteria, 1-10 scale, 3-band scoring (1-3 / 4-6 / 7-10). Video-primary source.

## Criteria

1. **Problem & Solution** — clarity and relevance of the problem; how well the solution addresses it
2. **Market Potential** — size, growth, accessibility of target market; customer segments
...
- **1-3**: Poor — problem unclear, no MVP, weak team, unrealistic model, poor delivery
- **4-6**: Adequate — clear but generic, prototype exists, competent team, feasible but unrefined
- **7-10**: Strong — well-evidenced problem, working product with differentiation, proven team, validated model, compelling delivery
